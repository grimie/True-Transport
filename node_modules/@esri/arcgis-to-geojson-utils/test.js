...
// for (let i=0; i < orders.features.length; i++) {
//   geojsonOrders.features.push(arcgisToGeoJSON(orders.features[i]))
// }

// console.log(JSON.stringify(geojsonOrders))

const depots = {"features":[{"geometry":{"x":-122.3943,"y":37.7967},"attributes":{"Name":"San Francisco","TimeWindowStart1":1355241600000,"TimeWindowEnd1":1355274000000}}]}
...
for (let i=0; i < routes.features.length; i++) {
  geojsonRoutes.features.push(arcgisToGeoJSON(routes.features[i]))
}

console.log("routes", JSON.stringify(geojsonRoutes))